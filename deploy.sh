...
DROPZONE_AUDIO_TTS_RETRY_ATTEMPTS="${DROPZONE_AUDIO_TTS_RETRY_ATTEMPTS:-5}"
DROPZONE_AUDIO_TTS_RETRY_BASE_DELAY_SECONDS="${DROPZONE_AUDIO_TTS_RETRY_BASE_DELAY_SECONDS:-1}"
