...
write_env_file() {
    {
        ...
        env_line DROPZONE_AUDIO_TTS_RETRY_ATTEMPTS "${DROPZONE_AUDIO_TTS_RETRY_ATTEMPTS:-8}"
        env_line DROPZONE_AUDIO_TTS_RETRY_BASE_DELAY_SECONDS "${DROPZONE_AUDIO_TTS_RETRY_BASE_DELAY_SECONDS:-2}"
...
export DROPZONE_AUDIO_TTS_RETRY_ATTEMPTS="${DROPZONE_AUDIO_TTS_RETRY_ATTEMPTS:-8}"
export DROPZONE_AUDIO_TTS_RETRY_BASE_DELAY_SECONDS="${DROPZONE_AUDIO_TTS_RETRY_BASE_DELAY_SECONDS:-2}"
