...
write_env_file() {
    {
        ...
        env_line DDGS_BACKEND "${DDGS_BACKEND:-duckduckgo}"
        ...
        env_line DROPZONE_IMAGE_FALLBACK_ATTEMPTS "${DROPZONE_IMAGE_FALLBACK_ATTEMPTS:-4}"
...
export DDGS_BACKEND="${DDGS_BACKEND:-duckduckgo}"
...
export DROPZONE_IMAGE_FALLBACK_ATTEMPTS="${DROPZONE_IMAGE_FALLBACK_ATTEMPTS:-4}"
