...
def patch_middleware(path: Path) -> None:
    ...
    patched = insert_after_one_of(
        ...
        "\n"
        "\n"
        "def _dropzone_fenced_text_block(text):\n"
        ...
        "        sections.extend(\n"
        "            [\n"
        "                '<details type=\"reasoning\" done=\"true\"><summary>Prompt planning</summary>',\n"
        "                prompt_reasoning,\n"
        "                '</details>',\n"
        "                '',\n"
        "            ]\n"
        ...
        "        if sections:\n"
        "            sections.append('')\n"
        "        sections.extend(['**Prompt sent**', _dropzone_fenced_text_block(prompt_text)])\n"
        "\n"
        "    params = []\n"
